...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { title: "開発営業", link: "/services/business-development" },
  ...
  },
  {
    ...
    icon: FaSolidBox,
    subItems: [
      { title: "商品紹介トップ", link: "/products" },
      { title: "開発営業", link: "/products/business-development" },
      { title: "建材", link: "/products/building-materials" },
      { title: "セメント", link: "/products/cement" },
      { title: "鋼材・土木", link: "/products/steel-civil-engineering" },
      { title: "金物", link: "/products/hardware" },
      { title: "化成品", link: "/products/chemical-products" },
      { title: "DX", link: "/products/dx" },
    ],
  },
  {
    title: "お知らせ",
